    ...
    protected function seedShopData(User $merchant): void
    {
        ...
        MerchantSetting::updateOrCreate(
            ...
            [
                ...
                'greeting_message' => "Welcome to J.Q Patisserie! 🥐\n\nArtisan French Pastries, Handcrafted with Love.\n\n• Browse our freshly baked pastries\n• Order custom cakes\n• Track your order\n• Ask about our daily specials!\n\nHow can we help you today?",
                'ai_tone' => 'friendly',
                'booking_form_template' => "🎂 To place an order, please provide:\n• Item name(s) & quantity\n• Preferred collection date & time\n• Delivery or Self-pickup?\n• Your address (for delivery)\n• Any special requests (e.g., message on cake)",
                'confirmation_template' => "✅ Your order is confirmed!\n\n🧁 Order Code: {code}\n📦 Items: {items}\n💰 Total: RM{total}\n🚚 Type: {fulfillment}\n📅 Collection: {collection_date}\n\nThank you for choosing J.Q Patisserie! 🥐",
                'reminder_template' => "🥐 Your order {code} is ready for pickup!\n\n📍 Address: 173, Jalan Paya 3/1, Kampung Paya, 86000 Kluang, Johor\n⏰ Hours: Tue-Fri 10am-7pm | Sat-Sun 9am-8pm\n\nPlease collect within your scheduled time. See you soon! 😊",
                'reminder_hours_before' => 24,
                'email_on_escalation' => true,
